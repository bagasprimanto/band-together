...
class OpenMicViewsTests(TestCase):
    ...
    def test_get_openmics_partial_view(self):
        ...
        self.assertTemplateUsed(
            response, "openmics/openmic_list_partial.html#openmics_list"
        )
        self.assertContains(response, self.openmic1.title)
    ...
    #     self.assertContains(response, "This endpoint only accepts HTMX requests.")
    ...
    #         reverse("openmics:add_comment", kwargs={"pk": self.openmic1.pk}),
    ...
    #     )
    #     response = self.client.post(
    #         reverse("openmics:delete_comment", kwargs={"pk": comment.pk})
    #     )
    #     self.assertEqual(response.status_code, 302)
    #     self.assertRedirects(
    #         response,
